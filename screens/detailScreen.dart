                            ...
                            Text(
                              ...
                              style: GoogleFonts.poppins(
                                textStyle: TextStyle(
                                  ...
                                  fontSize: 22.0, // Change the size as needed
 ...
 Row(
                            ...
                            Text(
                             'Working place',
                              style: GoogleFonts.poppins(
                                textStyle: TextStyle(
                                  color: Colors.black87,
                                  fontSize: 18.0, // Change the size as needed
                                  fontWeight: FontWeight.w600,
                                ),
                              ),
                            ),
                  ...
                  Center(
                      child: Row(
                        ...
                        children: [
                   Text(
                              ' ${doctor?.currentworkingplace ?? 'No Doctor Selected'}',

                              style: GoogleFonts.poppins(
                                textStyle: TextStyle(
                                  color: Colors.black87,
                                  fontSize: 14.0, // Change the size as needed
                ...
                Padding(
                  padding: const EdgeInsets.only(
                      top: 40, bottom: 5, right: 12, left: 12),
                ),
                Row(

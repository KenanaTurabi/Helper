...
List<PostUserModel> allUsers = [
  ...
  PostUserModel(
    userName: 'Ahmad',
    profileImage:
        'https://media.istockphoto.com/id/1071468786/photo/young-doctor-man-wearing-hospital-coat-over-isolated-background-smiling-pointing-to-head-with.jpg?s=2048x2048&w=is&k=20&c=cLk0mN7zfz2SSObWNiEdUA9oIrgef2DtGgZWbhLy5QY=',
  ),
  PostUserModel(
    userName: 'Tala',
    profileImage:

...
class _patientFullDataWiddgetState extends State<patientFullDataWiddget> {
  ...
  Future<void> fetchTreatmentPlan() async {
    final url = 'http://localhost:5000/getTreatmentPlan/${widget.patient.id}';
   ...
   bool result = await  Navigator.push(
              context,
              MaterialPageRoute(
                builder: (context) => DiagnosesPage(widget.patient,widget.isDark, widget.updateState),
              ),
            );
         ...
         color: Colors.white,
          ...
          child: SingleChildScrollView(
            ...
            child: Column(
              children: [
                Container(
                  width: double.infinity,
                  height: 400,
                  child: Image(image: AssetImage('assets/images/${widget.patient.image}'),),
           ...
           Container(
                 ...
                 child: Text(widget.patient.name ?? "No Name",
            ...
            child: Column(
              ...
              children: [
                  ...
                  Padding(
                      ...
                      child:Text(widget.patient.mobileNumber.toString()!),
                       ), ], ), Row(
                       mainAxisAlignment: MainAxisAlignment.center,
                        crossAxisAlignment: CrossAxisAlignment.center,
                   children: [
